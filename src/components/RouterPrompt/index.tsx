import React, { ReactNode, FC, memo, useEffect, useCallback, useState, useRef } from 'react';
...
const RouterPrompt: FC<IProps> = (props) => {
	...
	return (
		<Modal title="温馨提示" visible={open} onCancel={() => setOpen(false)} onOk={() => handleConfirm()}>
			{message}
		</Modal>
	);
};
