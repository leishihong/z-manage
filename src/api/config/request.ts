...
const { VITE_APP_ENV, VITE_APP_API_PREFIX, VITE_APP_BASE_URL } = import.meta.env;

export const baseURL = VITE_APP_ENV === 'dev' ? VITE_APP_API_PREFIX : `${VITE_APP_BASE_URL}${VITE_APP_API_PREFIX}`;
